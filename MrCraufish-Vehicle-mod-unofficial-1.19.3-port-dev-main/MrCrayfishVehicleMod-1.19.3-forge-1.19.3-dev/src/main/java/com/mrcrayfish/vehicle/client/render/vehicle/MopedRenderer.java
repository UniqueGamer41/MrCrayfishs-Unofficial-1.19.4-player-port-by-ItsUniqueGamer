    ...
    public void render(@Nullable MopedEntity vehicle, PoseStack matrixStack, MultiBufferSource renderTypeBuffer, float partialTicks, int light)
    {
        ...
        if(!wheelStack.isEmpty())
        {
            ...
            if(wheel != null)
            {
                ...
                RenderObjectHelper.renderColoredModel(wheelModel, ItemDisplayContext.NONE, false, matrixStack, renderTypeBuffer, wheelColor, OverlayTexture.NO_OVERLAY, light);
            }
            matrixStack.popPose();
        }
